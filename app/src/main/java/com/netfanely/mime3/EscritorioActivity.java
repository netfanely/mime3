...
import com.netfanely.mime3.iniciarsesion.QuienesSomosFragment;
...
public class EscritorioActivity extends AppCompatActivity
    ...
    private void mostrarCategoriasProductos() {
        setTitle("Categorías");
        getSupportFragmentManager().beginTransaction()
                .replace(R.id.contenedor_principal, new CategoriasProductoFragment())
                .commit();
    }
    ...
    private void mostrarCategorias() {
        setTitle("Categorías");
        getSupportFragmentManager().beginTransaction()
                .replace(R.id.contenedor_principal, new CategoriasFragment())
                .commit();
    }
}
